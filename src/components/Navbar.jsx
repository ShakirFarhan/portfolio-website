  ...
  return (
    <>
      ...
      >
        ...
        <div className={`w-full md:flex md:items-center md:w-auto duration-1000 bg-white  ${toggleNav ? "absolute top-10 left-0 px-4" : "hidden"}`} id="menu">
          <ul
            className="
              pt-4
              ...
              md:items-center
              md:justify-between 
              md:pt-0 duration-1000"
          >
            <li>
              <a className="md:p-4 py-2 block hover:text-purple-400" href="#skills">
                Skills
              </a>
            </li>
            <li>
              <a className="md:p-4 py-2 block hover:text-purple-400" href="#projects">
                Projects
              </a>
            </li>
            <li>
              <a className="md:p-4 py-2 block hover:text-purple-400" href="#education">
                Education
              </a>
            </li>
            <li>
              <a className="md:p-4 py-2 block hover:text-purple-400" href="#experience">
                Experience
              </a>
            </li>
            <li>
              <a className="md:p-4 py-2 block hover:text-purple-400 " href="#contact">
                Contact
              </a>
            </li>
